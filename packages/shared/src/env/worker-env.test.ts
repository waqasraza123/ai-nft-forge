...
describe("parseWorkerEnv", () => {
  it("applies stable defaults for the worker shell", () => {
    ...
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_SCHEDULE_ENABLED).toBe(false);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_RUN_ON_START).toBe(true);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_INTERVAL_SECONDS).toBe(300);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_JITTER_SECONDS).toBe(15);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_LOCK_TTL_SECONDS).toBe(600);
  ...
  it("parses explicit values", () => {
    const env = parseWorkerEnv({
      ...
      WORKSPACE_LIFECYCLE_AUTOMATION_INTERVAL_SECONDS: "1200",
      WORKSPACE_LIFECYCLE_AUTOMATION_JITTER_SECONDS: "30",
      WORKSPACE_LIFECYCLE_AUTOMATION_LOCK_TTL_SECONDS: "1500",
      WORKSPACE_LIFECYCLE_AUTOMATION_RUN_ON_START: "false",
    ...
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_SCHEDULE_ENABLED).toBe(true);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_RUN_ON_START).toBe(false);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_INTERVAL_SECONDS).toBe(1200);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_JITTER_SECONDS).toBe(30);
    expect(env.WORKSPACE_LIFECYCLE_AUTOMATION_LOCK_TTL_SECONDS).toBe(1500);

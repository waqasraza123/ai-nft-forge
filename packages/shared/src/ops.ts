...
export const opsWorkspaceAuditEntrySchema = z.object({
  ...
  previousAutomateDecommissionNotices: z.boolean().nullable(),
  previousAutomateInvitationReminders: z.boolean().nullable(),
  previousDefaultDecommissionRetentionDays: z.number().int().nullable(),
  previousDeliverDecommissionNotifications: z.boolean().nullable(),
  previousDeliverInvitationReminders: z.boolean().nullable(),
  previousLifecycleAutomationEnabled: z.boolean().nullable(),
  previousLifecycleSlaAutomationMaxAgeMinutes: z.number().int().nullable(),
  previousLifecycleSlaEnabled: z.boolean().nullable(),
  previousLifecycleSlaWebhookFailureThreshold: z.number().int().nullable(),
  previousMinimumDecommissionRetentionDays: z.number().int().nullable(),
  previousRequireDecommissionReason: z.boolean().nullable(),
  previousRole: studioWorkspaceRoleSchema.nullable(),
  previousWebhookEnabled: z.boolean().nullable(),

    ...
    exportAccessibleWorkspaceRetentionReportCsv(input: {
      ...
      const rows = [
        [
          ...
          "access_review_latest_recorded_at",
      ...
      for (const workspace of input.reportData.report.workspaces) {
        rows.push(
          [
            ...
            workspace.accessReview.attestationStatus,
            workspace.accessReview.currentEvidenceHash,
            workspace.accessReview.latestAttestation?.reviewHash ?? null,
            workspace.accessReview.latestAttestation?.createdAt ?? null,

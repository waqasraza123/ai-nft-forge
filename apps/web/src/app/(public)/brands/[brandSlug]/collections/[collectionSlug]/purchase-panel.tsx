        ...
        <section className="space-y-4">
          ...
          {props.checkoutEnabled ? (
            <form className="space-y-3" onSubmit={handleSubmit}>
              ...
              <ActionRow compact>
                <StorefrontActionButton disabled={busy} type="submit">
                  {busy
                    ? "Starting checkout..."
        ...
        <StorefrontPanel className="p-4" tone="soft">
          ...
          <StorefrontTile className="p-3" tone="muted">
            <StorefrontSectionHeading
              ...
              title="Availability checkpoint"
            />
            <StorefrontMetaGrid className="mt-3">
              <StorefrontMetaItem
                label="Open editions"
                value={`${props.availableEditionCount} remaining`}
              />
              <StorefrontMetaItem
                label="Held right now"
                value={`${props.activeReservationCount} reservations`}
              />
              <StorefrontMetaItem
                label="Checkout state"
                value={props.checkoutEnabled ? "Live" : "Disabled"}
              />
            </StorefrontMetaGrid>
          </StorefrontTile>

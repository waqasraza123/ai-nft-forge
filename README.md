...
- Owner-only workspace access review export plus deterministic evidence hashes, current/changed attestation freshness, and audit-backed review attestation history for governance handoff as JSON or CSV

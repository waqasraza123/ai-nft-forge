...
- Owner-only workspace export and offboarding packets that carry access-review freshness evidence alongside archive-readiness, lifecycle, commerce, and ops state, with stale or missing reviews treated as offboarding cautions

...
- `/ops/audit` can filter and export access, ownership-transfer, workspace lifecycle, and workspace policy audit categories from the selected workspace, including structured decommission and policy metadata columns

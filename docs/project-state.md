...
- The studio and public surfaces now expose per-asset generation history, owner-scoped collection drafts, durable studio settings, storefront merchandising, preset-driven public presentation, published collection launch pages, item-level manual or Stripe-hosted checkout, owner-side commerce administration, and webhook fulfillment automation, but multi-brand administration is still deferred.
